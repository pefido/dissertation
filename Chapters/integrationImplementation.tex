...
\Upon { message:}
  \If {$message.type$ = "contentFromNetwork"}
      \State {$operationInfo$ $\gets$ parse($message.content$)}
      \State {Send request($operationInfo$)}
      \Upon { $answer$:}
        \Return {$answer$}
      \End
  \EndIf
